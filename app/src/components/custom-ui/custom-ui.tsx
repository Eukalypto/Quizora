...
function NavigationSidebar({
  ...
  return (
    <div className="hidden h-full items-center lg:flex">
      <Sidebar.Root
        className="m-2.5"
        style={{ height: "auto", ["--q-sidebar-radius" as string]: "12px" } as CSSProperties}
      >
        <Sidebar.Header>
          <Sidebar.Switcher>
            <Sidebar.Logo>
  ...
  return (
    <div className="flex h-dvh min-h-0 bg-q-background-primary text-q-text-primary">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <nav
          className="flex shrink-0 items-stretch justify-around gap-1 border-t border-q-border-subtle px-2 pt-1.5 lg:hidden"
